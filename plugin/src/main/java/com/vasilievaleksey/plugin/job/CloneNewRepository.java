...
@Component
public class CloneNewRepository implements JobRunner, InitializingBean, DisposableBean {
    @ComponentImport
    private final SchedulerService schedulerService;
    private final RepositoryService repositoryService;

    private final static String IDENTIFIER = CloneNewRepository.class.getName();
    ...
    @Autowired
    public CloneNewRepository(SchedulerService schedulerService, RepositoryService repositoryService) {
